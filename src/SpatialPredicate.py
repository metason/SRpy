...
class SpatialTerms:
    ...
    list: List[PredicateTerm] = [
        ...
        PredicateTerm(
            code=SpatialPredicate.left,
            predicate="left",
            preposition="of",
            synonym="to the left",
        ),
        PredicateTerm(
            code=SpatialPredicate.right,
            predicate="right",
            preposition="of",
            synonym="to the right",
        ),
        PredicateTerm(
            code=SpatialPredicate.ahead,
            predicate="ahead",
            preposition="of",
            synonym="before",
        ),
        PredicateTerm(
            code=SpatialPredicate.behind,
            predicate="behind",
            preposition="",
            synonym="after",
        ),
        PredicateTerm(
            code=SpatialPredicate.above,
            predicate="above",
            preposition="",
            synonym="over",
            reverse="below",
        ...
        PredicateTerm(
            code=SpatialPredicate.l,
            predicate="left",
            preposition="of",
            synonym="to the left",
        ),
        PredicateTerm(
            code=SpatialPredicate.r,
            predicate="right",
            preposition="of",
            synonym="to the right",
        ),
        PredicateTerm(
            code=SpatialPredicate.a,
            predicate="ahead",
            preposition="of",
            synonym="before",
        ),
        PredicateTerm(
            code=SpatialPredicate.b, predicate="behind", preposition="", synonym="after"
        ),
        PredicateTerm(
            code=SpatialPredicate.o,
            predicate="above",
            preposition="",
            synonym="over",
            reverse="below",
        ...
        PredicateTerm(
            code=SpatialPredicate.upperside,
            predicate="at upper side",
            preposition="of",
            reverse="at lower side",
        ),
        PredicateTerm(
            code=SpatialPredicate.lowerside,
            predicate="at lower side",
            preposition="of",
            reverse="at upper side",
        ),
        PredicateTerm(
            code=SpatialPredicate.leftside,
            predicate="at left side",
            preposition="of",
            synonym="at left-hand side",
        ),
        PredicateTerm(
            code=SpatialPredicate.rightside,
            predicate="at right side",
            preposition="of",
            synonym="at right-hand side",
        ),
        PredicateTerm(
            code=SpatialPredicate.frontside,
            predicate="at front side",
            preposition="of",
            synonym="at forefront",
        ),
        PredicateTerm(
            code=SpatialPredicate.backside,
            predicate="at back side",
            preposition="of",
            synonym="at rear side",
        ),
        # orientations
        PredicateTerm(
            code=SpatialPredicate.aligned,
            predicate="aligned",
            preposition="with",
            synonym="parallel",
            reverse="aligned",
        ...
        PredicateTerm(
            code=SpatialPredicate.orthogonal,
        ...
        PredicateTerm(
            code=SpatialPredicate.opposite,
            predicate="opposite",
            preposition="",
            synonym="vis-a-vis",
            reverse="opposite",
        ...
        PredicateTerm(
            code=SpatialPredicate.containing,
        ...
        PredicateTerm(
            code=SpatialPredicate.crossing, predicate="crossing", preposition=""
        ),
        PredicateTerm(
            code=SpatialPredicate.overlapping,
            predicate="overlapping",
            preposition="",
            synonym="intersecting",
            reverse="overlapping",
            antonym="disjoint",
        ),
        PredicateTerm(
            code=SpatialPredicate.disjoint,
            predicate="disjoint",
            preposition="to",
            reverse="disjoint",
            antonym="overlapping",
        ...
        PredicateTerm(
            code=SpatialPredicate.touching,
            predicate="touching",
            preposition="with",
            reverse="touching",
        ),
        PredicateTerm(
            code=SpatialPredicate.frontaligned,
            predicate="front aligned",
            preposition="with",
            reverse="front aligned",
        ),
        PredicateTerm(
            code=SpatialPredicate.meeting,
            predicate="meeting",
            preposition="",
            reverse="meeting",
        ),
        PredicateTerm(
            code=SpatialPredicate.beside,
            predicate="beside",
            preposition="",
            reverse="beside",
        ),
        PredicateTerm(
            code=SpatialPredicate.fitting,
            predicate="fitting",
            preposition="into",
            reverse="exceeding",
        ),
        PredicateTerm(
            code=SpatialPredicate.exceeding,
            predicate="exceeding",
            preposition="into",
            reverse="fitting",
        ),
        # connectivity
        PredicateTerm(
            code=SpatialPredicate.on, predicate="on", preposition="", reverse="beneath"
        ),
        PredicateTerm(
            code=SpatialPredicate.at, predicate="at", preposition="", reverse="meeting"
        ),
        PredicateTerm(
            code=SpatialPredicate.by, predicate="by", preposition="", reverse="by"
        ),
        PredicateTerm(
            code=SpatialPredicate.in_,
            predicate="in",
            preposition="",
            reverse="containing",
        ),
        # similarity
        PredicateTerm(
            code=SpatialPredicate.samewidth,
            predicate="same width",
            preposition="as",
            synonym="similar width",
            reverse="same width",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.sameheight,
            predicate="same height",
            preposition="as",
            synonym="similar height",
            reverse="same height",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samedepth,
            predicate="same depth",
            preposition="as",
            synonym="similar depth",
            reverse="same depth",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samelength,
            predicate="same length",
            preposition="as",
            synonym="similar length",
            reverse="same length",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samefootprint,
            predicate="same footprint",
            preposition="as",
            synonym="similar base area",
            reverse="same footprint",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samefront,
            predicate="same front face",
            preposition="as",
            synonym="similar front face",
            reverse="same front face",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.sameside,
            predicate="same side face",
            preposition="as",
            synonym="similar side face",
            reverse="same side face",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samevolume,
            predicate="same volume",
            preposition="as",
            synonym="similar volume",
            reverse="same volume",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samecuboid,
            predicate="same cuboid",
            preposition="as",
            synonym="similar cuboid",
            reverse="same cuboid",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.samecenter,
            predicate="same center",
            preposition="as",
            synonym="similar center",
            reverse="same center",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.sameshape,
            predicate="same shape",
            preposition="as",
            synonym="similar shape",
            reverse="same shape",
            verb="has",
        ),
        PredicateTerm(
            code=SpatialPredicate.congruent,
            predicate="congruent",
            preposition="as",
            reverse="congruent",
        ),
        ...
        PredicateTerm(
            code=SpatialPredicate.shorter,
            predicate="shorter",
            preposition="than",
            reverse="longer",
        ),
        PredicateTerm(
            code=SpatialPredicate.longer,
            predicate="longer",
            preposition="than",
            reverse="shorter",
        ),
        PredicateTerm(
            code=SpatialPredicate.taller,
            predicate="taller",
            preposition="than",
            reverse="shorter",
        ),
        PredicateTerm(
            code=SpatialPredicate.thinner,
            predicate="thinner",
            preposition="than",
            synonym="narrower",
            reverse="wider",
...
directionality: List[SpatialPredicate] = [
    SpatialPredicate.left,
    SpatialPredicate.right,
    SpatialPredicate.above,
    SpatialPredicate.below,
    SpatialPredicate.ahead,
    SpatialPredicate.behind,
]
adjacency: List[SpatialPredicate] = [
    SpatialPredicate.leftside,
    SpatialPredicate.rightside,
    SpatialPredicate.ontop,
    SpatialPredicate.beneath,
    SpatialPredicate.upperside,
    SpatialPredicate.lowerside,
    SpatialPredicate.frontside,
    SpatialPredicate.backside,
]
orientations: List[SpatialPredicate] = [
    SpatialPredicate.orthogonal,
    SpatialPredicate.opposite,
    SpatialPredicate.aligned,
    SpatialPredicate.frontaligned,
    SpatialPredicate.backaligned,
    SpatialPredicate.rightaligned,
    SpatialPredicate.leftaligned,
]
assembly: List[SpatialPredicate] = [
    SpatialPredicate.disjoint,
    SpatialPredicate.inside,
    SpatialPredicate.containing,
    SpatialPredicate.overlapping,
    SpatialPredicate.crossing,
    SpatialPredicate.touching,
    SpatialPredicate.meeting,
    SpatialPredicate.beside,
]
topology: List[SpatialPredicate] = (
    proximity + directionality + adjacency + orientations + assembly
)
contacts: List[SpatialPredicate] = [
    SpatialPredicate.on,
    SpatialPredicate.at,
    SpatialPredicate.by,
    SpatialPredicate.in_,
]
connectivity: List[SpatialPredicate] = [
    SpatialPredicate.on,
    SpatialPredicate.at,
    SpatialPredicate.by,
    SpatialPredicate.in_,
...
comparability: List[SpatialPredicate] = [
    SpatialPredicate.smaller,
    SpatialPredicate.bigger,
    SpatialPredicate.shorter,
    SpatialPredicate.longer,
    SpatialPredicate.taller,
    SpatialPredicate.thinner,
    SpatialPredicate.wider,
    SpatialPredicate.fitting,
    SpatialPredicate.exceeding,
]
similarity: List[SpatialPredicate] = [
    SpatialPredicate.sameheight,
    SpatialPredicate.samewidth,
    SpatialPredicate.samedepth,
    SpatialPredicate.samelength,
    SpatialPredicate.samefront,
    SpatialPredicate.sameside,
    SpatialPredicate.samefootprint,
    SpatialPredicate.samevolume,
    SpatialPredicate.samecenter,
    SpatialPredicate.samecuboid,
    SpatialPredicate.congruent,
    SpatialPredicate.sameshape,
]
visibility: List[SpatialPredicate] = [
    SpatialPredicate.seenleft,
    SpatialPredicate.seenright,
    SpatialPredicate.infront,
    SpatialPredicate.atrear,
    SpatialPredicate.tangible,
    SpatialPredicate.eightoclock,
    SpatialPredicate.nineoclock,
    SpatialPredicate.tenoclock,
    SpatialPredicate.elevenoclock,
    SpatialPredicate.twelveoclock,
    SpatialPredicate.oneoclock,
    SpatialPredicate.twooclock,
    SpatialPredicate.threeoclock,
    SpatialPredicate.fouroclock,
]
geography: List[SpatialPredicate] = [
    SpatialPredicate.north,
    SpatialPredicate.south,
    SpatialPredicate.east,
    SpatialPredicate.west,
    SpatialPredicate.northwest,
    SpatialPredicate.northeast,
    SpatialPredicate.southwest,
    SpatialPredicate.southeast,
]
sectors: List[SpatialPredicate] = [
    ...
    SpatialPredicate.ro,
    SpatialPredicate.ru,
    SpatialPredicate.alo,
    SpatialPredicate.aro,
    SpatialPredicate.blo,
    SpatialPredicate.bro,
    SpatialPredicate.alu,
    SpatialPredicate.aru,
    SpatialPredicate.blu,
    SpatialPredicate.bru,
]
